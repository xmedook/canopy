...
- **Signal Network Function**: Receives prospect data, deal signals, market intelligence, and revenue targets and transmits spec and inform signals in markdown format. Primary transcoding: prospect data → outbound playbook output.
...
## Signal Network
- **Receives**: prospect data, deal signals, market intelligence, revenue targets
...
- **Transcoding** (tools as signal converters):
  ...
  - WebSearch: query → external information
