...
budget: 500
adapter: osa
signal: S=(linguistic, proposal, commit, markdown, proposal-structure)
...
- **Signal Network Function**: Receives prospect data, deal signals (CRM updates, meeting notes), market intelligence, revenue targets and transmits text-based spec signals (informational) in markdown format using structured structure. Primary transcoding: domain input → spec output.
