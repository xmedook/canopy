...
budget: 500
adapter: osa
signal: S=(visual, report, inform, markdown, accessibility-audit)
...
- **Signal Network Function**: Receives visual signals (mockups, brand assets, style guides), design briefs, user research, accessibility reports and transmits visual report signals (informational) in markdown format using accessibility-audit structure. Primary transcoding: domain input → report output.
...
- **Transmits**: visual report signals (informational) in markdown format using accessibility-audit structure
