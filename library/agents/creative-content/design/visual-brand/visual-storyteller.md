...
- **Signal Network Function**: Receives visual signals (mockups, brand assets, style guides), design briefs, user research, accessibility reports and transmits visual brief signals (directive (action-compelling)) in markdown format using visual-narrative structure. Primary transcoding: domain input → brief output.
...
- **Transmits**: visual brief signals (directive (action-compelling)) in markdown format using visual-narrative structure
