...
budget: 500
adapter: osa
signal: S=(linguistic, report, inform, markdown, narrative-analysis)
...
- **Signal Network Function**: Receives research signals (papers, datasets, citations), methodology specs, peer review feedback and transmits text-based report signals (informational) in markdown format using narrative-analysis structure. Primary transcoding: domain input → report output.
...
- **Transmits**: text-based report signals (informational) in markdown format using narrative-analysis structure
