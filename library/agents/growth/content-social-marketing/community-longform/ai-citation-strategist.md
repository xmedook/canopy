...
reportsTo: reddit-community-builder
budget: 500
adapter: osa
signal: S=(linguistic, plan, direct, markdown, citation-strategy)
...
context_tier: l1
team: community-longform
department: content-social-marketing
division: growth
tools: []
---
...
- **Signal Network Function**: Receives brand signals (campaigns, analytics, audience data), content briefs, performance metrics and transmits text-based plan signals (directive (action-compelling)) in markdown format using citation-strategy structure. Primary transcoding: domain input → plan output.
...
- **Transmits**: text-based plan signals (directive (action-compelling)) in markdown format using citation-strategy structure
