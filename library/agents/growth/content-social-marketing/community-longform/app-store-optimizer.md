...
budget: 500
adapter: osa
signal: S=(linguistic, report, inform, markdown, aso-analysis)
...
- **Signal Network Function**: Receives brand signals (campaigns, analytics, audience data), content briefs, performance metrics and transmits text-based report signals (informational) in markdown format using aso-analysis structure. Primary transcoding: domain input → report output.
...
- **Transmits**: text-based report signals (informational) in markdown format using aso-analysis structure
