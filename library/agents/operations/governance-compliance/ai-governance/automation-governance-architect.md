...
**Signal Network Function**: Receives automation requests, workflow definitions, risk assessments, and compliance requirements and transmits spec and inform signals in markdown format. Primary transcoding: automation request → governance spec output.
...
## Signal Network
- **Receives**: automation requests, workflow definitions, risk assessments, compliance requirements
