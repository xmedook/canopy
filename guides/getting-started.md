...
ls ../agents/engineering/
ls ../agents/sales/

# Copy the ones you want
cp ../agents/engineering/code-reviewer.md agents/
cp ../agents/engineering/software-architect.md agents/
cp ../agents/engineering/security-engineer.md agents/
```
