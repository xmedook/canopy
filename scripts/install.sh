#!/usr/bin/env bash
#
# install.sh -- Install agents into your local agentic tool(s).
#
...
#   gemini-cli   -- Install extension to ~/.gemini/extensions/osa-operations/
#   opencode     -- Copy agents to .opencode/agent/ in current directory
#   cursor       -- Copy rules to .cursor/rules/ in current directory
#   aider        -- Copy CONVENTIONS.md to current directory
#   windsurf     -- Copy .windsurfrules to current directory
#   openclaw     -- Copy workspaces to ~/.openclaw/osa-operations/
...
install_gemini_cli() {
  ...
  local dest="${HOME}/.gemini/extensions/osa-operations"
  local count=0
...
install_openclaw() {
  ...
  local dest="${HOME}/.openclaw/osa-operations"
  local count=0
